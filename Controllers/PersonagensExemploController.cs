...
namespace RpgApi.Controllers
{
    ...
    public class PersonagensExemploController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult AddPersoganem(Personagem novoPersonagem)
        {
            if (novoPersonagem.Inteligencia == 0)
            return BadRequest("Inteligência não poder ter o valor igual a 0 (zero.)");
        ...
        {
            List<Personagem> listaBusca = personagens.FindAll(p => p.Classe != ClasseEnun.Cavaleiro);
        ...
        {
            Personagem pRemove = personagens.Find(p => p.Classe == ClasseEnun.Mago);
        ...
        {
            ClasseEnun enumDigitado = (ClasseEnun)enumId;
